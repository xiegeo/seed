// generated by go run github.com/globusdigital/deep-copy --type I18n --type Thing --type Field --type FieldProperties --type Object --type Domain -o gen_deep_copy.go .; DO NOT EDIT.
...
// DeepCopy generates a deep copy of FieldProperties
func (o FieldProperties) DeepCopy() FieldProperties {
	var cp FieldProperties = o
	if o.Fields != nil {
	...
	if o.Identities != nil {
		cp.Identities = make([]Identity, len(o.Identities))
		copy(cp.Identities, o.Identities)
		for i2 := range o.Identities {
			if o.Identities[i2].Fields != nil {
				cp.Identities[i2].Fields = make([]CodeName, len(o.Identities[i2].Fields))
				copy(cp.Identities[i2].Fields, o.Identities[i2].Fields)
			}
			if o.Identities[i2].Ranges != nil {
				cp.Identities[i2].Ranges = make([]Range, len(o.Identities[i2].Ranges))
				copy(cp.Identities[i2].Ranges, o.Identities[i2].Ranges)
			}
		}
	}
	if o.Ranges != nil {
		cp.Ranges = make([]Range, len(o.Ranges))
		copy(cp.Ranges, o.Ranges)
	}
	return cp
}
...
func (o Object) DeepCopy() Object {
	var cp Object = o
	cp.Thing = o.Thing.DeepCopy()
	cp.FieldProperties = o.FieldProperties.DeepCopy()
	return cp
}
